...
def iniciar_interfaz():
    ...
    frame_botones_pagina = tk.Frame(root)
    frame_botones_pagina.grid(row=1, column=0, pady=10)

    btn_atras = tk.Button(frame_botones_pagina, text="Página anterior", command=lambda: cambiar_pagina("atras"))
    btn_atras.grid(row=0, column=0, padx=5)

    btn_adelante = tk.Button(frame_botones_pagina, text="Página siguiente", command=lambda: cambiar_pagina("adelante"))
